...
efficiencyList.append(["mu_recoEta", binningDict["etaFine"], "Eta1_reco", cutDict["diMu-gmtPt1"], cutDict["recoPt1"], [0, 0.05]])
efficiencyList.append(["mu_recoPhi", binningDict["phiFine"], "Phi1_reco", cutDict["diMu-gmtPt1"], cutDict["recoPt1"], [0, 0.05]])
efficiencyList.append(["mu_recoPt", binningDict["ptFine"], "pT1_reco", cutDict["diMu-gmtPt1"], cutDict["recoPt1"], [0, 0.05]])
